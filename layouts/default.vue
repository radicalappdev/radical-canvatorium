    ...
    <header class="fixed top-0 w-full h-24 bg-slate-800 text-white px-3">
      <div class="flex flex-col">
        ...
        <div class="flex flex-row w-full mt-1">
          <button @click="showLab" :class="{'border border-slate-500 rounded-l-md bg-slate-900 text-white font-semibold focus:outline-none': activeTab === 'lab', 'bg-slate-700 rounded-l-md': activeTab !== 'lab'}" class="flex-1 py-1 focus:outline-none">Lab Scene</button>
          <button @click="showLabNotes" :class="{'border border-slate-500 rounded-r-md bg-slate-900 text-white font-semibold focus:outline-none': activeTab === 'lab-notes', 'bg-slate-700 rounded-r-md': activeTab !== 'lab-notes'}" class="flex-1 py-1 focus:outline-none">Lab Notes</button>
        </div>
